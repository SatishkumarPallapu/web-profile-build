...
const ProjectCard = ({ project, index, isVisible }: ProjectCardProps) => {
  ...
  return (
    <>
      <Card 
        className="group hover-lift border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden bg-white/90 backdrop-blur-sm opacity-100 animate-scale-in cursor-pointer" 
      ...
      >
        ...
        <CardContent className="p-3 sm:p-4 lg:p-6">
          ...
          <div className="flex justify-center">
            <Button 
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-xs sm:text-sm"
              onClick={(e) => {
                e.stopPropagation();
